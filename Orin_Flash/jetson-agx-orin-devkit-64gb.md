...
These are the flashing instructions for the [Jetson AGX Orin Developer Kit 64GB](https://www.nvidia.com/en-us/autonomous-machines/embedded-systems/jetson-orin/). [See here](https://github.com/balena-os/jetson-flash/tree/alanb-documentation?tab=readme-ov-file#instructions) for the list of other balena-supported Jetson devices. 
...
|------------------|-------------|-----------------|----------------------------------|
| 6.0 or later     | 36.3        | 6.0             | you are on the current version.     |
| lower than 6.0   | 35.5        | 5.x             | [v0.5.72](https://github.com/balena-os/jetson-flash/tree/v0.5.72) |
