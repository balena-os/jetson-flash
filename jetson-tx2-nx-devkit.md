...
These are the flashing instructions for the Jetson TX2 NX (in Jetson Xavier NX Devkit). For the list of other balena-supported Jetson devices [See here](https://github.com/balena-os/jetson-flash?tab=readme-ov-file#instructions).
