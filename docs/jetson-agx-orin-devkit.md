...
|------------------|-------------|-----------------|----------------------------------|
| 8.0.0 or later   | 39.2.0      | 7.2             | You are on the correct version. (v0.5.97 or greater) |
| 7.0.5 - 7.9.4+rev2 | 36.5.0      | 6.2.2         | [v0.5.96](https://github.com/balena-os/jetson-flash/tree/v0.5.96) |
...
The steps below should only be used for provisioning Jetson AGX Orin 32GB balenaOS images on Jetson AGX Orin 32GB hardware. Do not use the jetson-flash Node.js tool to provision Jetson AGX Orin 64GB hardware or Jetson AGX Orin 64GB device-type images. For the 64GB developer kit please refer to the [Jetson AGX Orin 64GB Developer Kit provisioning instructions](https://github.com/balena-os/jetson-flash/blob/master/docs/jetson-agx-orin-devkit-64gb.md)
