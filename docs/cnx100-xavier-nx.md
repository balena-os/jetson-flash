# Instructions for the Auvidea CNX100 Xavier NX


These are the flashing instructions for the Auvidea CNX100 Xavier NX. For the list of other balena-supported Jetson devices [See here](../README.md#instructions).
...
|------------------|-------------|-----------------|----------------------------------|
| 2.85.2+rev1      | 32.5.1      |  	4.5.1      |   [v0.5.17](https://github.com/balena-os/jetson-flash/tree/v0.5.17)   |
...
We only test jetson-flash on the reference NVIDIA carrier boards. Please consult the Auvidea CNX100 for Nvidia Jetson Xavier NX user manual for the proper recovery mode steps.
...
**NOTE**: The `jetson-xavier-nx-devkit-emmc` argument should be passed in command-line when flashing the Auvidea CNX100 Xavier NX.
