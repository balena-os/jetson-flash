# Instructions for CTI Photon TX2 NX

These are the flashing instructions for the CTI Photon TX2 NX. For the list of other balena-supported Jetson devices [See here](../README.md#instructions).
...
|------------------|-------------|-----------------|----------------------------------|
| 2.113.14      | 32.7.2 | 4.6.2           |   [v0.5.38](https://github.com/balena-os/jetson-flash/tree/v0.5.38)          |
| 2.98.12       | 32.7.1 | 4.6.1           |   [v0.5.28](https://github.com/balena-os/jetson-flash/tree/v0.5.28)          |
| 2.88.4+rev3   | 32.6.1 | 4.6             |   [v0.5.21](https://github.com/balena-os/jetson-flash/tree/v0.5.21)          |
|2.82.11+rev12  | 32.5.1 | 4.5.1           |   [v0.5.13](https://github.com/balena-os/jetson-flash/tree/v0.5.13)          |
...
We only test jetson-flash on the reference NVIDIA carrier boards. Please consult the Connect Tech Photon AI Camera Platform for Nvidia Jetson TX2 NX user manual for the proper recovery mode steps.
...
**NOTE**: The `jetson-tx2-nx-devkit` argument should be passed in command-line when flashing the CTI Photon TX2 NX.
