# Instructions for the CTI Photon Xavier NX


These are the flashing instructions for the CTI Photon Xavier NX. For the list of other balena-supported Jetson devices [See here](../README.md#instructions).
...
|------------------|-------------|-----------------|----------------------------------|
| 4.0.9+rev2       | 32.7.3      | 4.6.3           |   [v0.5.54](https://github.com/balena-os/jetson-flash/tree/v0.5.54)      |
| 2.98.33          | 32.7.1      | 4.6.1           |   [v0.5.33](https://github.com/balena-os/jetson-flash/tree/v0.5.33)      |
| 2.88.4+rev10     | 32.6.1      | 4.6             |   [v0.5.23](https://github.com/balena-os/jetson-flash/tree/v0.5.23)      |
| 2.82.11+rev8     | 32.5.1      | 4.5.1           |   [v0.5.17](https://github.com/balena-os/jetson-flash/tree/v0.5.17)      |
| 2.67.3+rev5      | 32.4.4      | 4.4.1           |   [v0.5.4](https://github.com/balena-os/jetson-flash/tree/v0.5.4)        |
| 2.58.6+rev5      | 32.4.3      | 4.4             |   [v0.5.3](https://github.com/balena-os/jetson-flash/tree/v0.5.3)        |
...
We only test jetson-flash on the reference NVIDIA carrier boards. Please consult the Connect Tech Photon AI Camera Platform for Nvidia Jetson Xavier NX user manual for the proper recovery mode steps.
...
**NOTE**: The `jetson-xavier-nx-devkit-emmc` argument should be passed in command-line when flashing the CTI Photon Xavier NX.
