...
const argv = yargs
	...
	.option('m', {
		...
		choices: ['jetson-tx2', 'jetson-tx2-4GB', 'jetson-xavier-nx-devkit-tx2-nx', 'jetson-nano-emmc', 'jetson-nano-qspi-sd', 'jetson-nano-2gb-devkit', 'jetson-xavier', 'dv-kbr-xavier-nx-emmc', 'jetson-xavier-nx-devkit-emmc', "jetson-xavier-nx-devkit", "jetson-agx-orin-devkit"],
		required: true,
		type: 'string',
	})
	.alias('f', 'file')
