...
const run = async options => {
	...
	console.log("The above License Agreement can be consulted at https://developer.download.nvidia.com/embedded/L4T/r39_Release_v2.0/release/Tegra_Software_License_Agreement-Tegra-Linux.txt");
