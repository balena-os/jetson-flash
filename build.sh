...
JETSON_FLASH_BSP_URL="https://developer.nvidia.com/embedded/l4t/r32_release_v7.2/t186/jetson_linux_r32.7.2_aarch64.tbz2"
...
case "${DEVICE_TYPE}" in
        jetson-agx-orin-devkit)
            JETSON_FLASH_BSP_URL="https://developer.nvidia.com/downloads/embedded/l4t/r36_release_v3.0/release/jetson_linux_r36.3.0_aarch64.tbz2"
            ;;
        jetson-nano-qspi-sd)
        ...
        jetson-nano-emmc)
            ...
            ;;
        *)
            echo $"Using default L4T 32.7.2 BSP ${JETSON_FLASH_BSP_URL}"
esac
