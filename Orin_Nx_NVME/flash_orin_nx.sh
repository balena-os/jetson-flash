...
elif [[ $balena_device_name = "jetson-xavier-nx-devkit-emmc" ]]; then
	device_type="jetson-xavier-nx-devkit-emmc"
	device_dir="xavier_nx/"
	device_dtb="tegra194-p3668-0001-p3509-0000.dtb"
else
...
function setup_orin_rcmboot() {
    ...
    sed -i 's/console=tty0/root=LABEL=flash-rootA flasher /g' "${device_dir}${lt_dir}/p3668.conf.common"
