...
module.exports = class ResinJetsonFlash {
	...
	spawnFlash() {
		return new Bluebird(async (resolve, reject) => {
			...
			fs.copyFileSync(path.resolve(__dirname, '../Config_Files_For_SDK_Manager/brma3n-tx2-nx.conf'), workPath + '/jetson-xavier-nx-devkit-tx2-nx.conf');
			fs.copyFileSync(path.resolve(__dirname, '../Config_Files_For_SDK_Manager/bootloader/t186ref/BCT/tegra186-mb1-bct-pinmux-brma3n-tx2-nx.cfg'), workPath + '/bootloader/t186ref/BCT/tegra186-mb1-bct-pinmux-brma3n-tx2-nx.cfg');
			fs.copyFileSync(path.resolve(__dirname, '../Config_Files_For_SDK_Manager/bootloader/t186ref/BCT/tegra186-mb1-bct-pad-brma3n-tx2-nx.cfg'), workPath + '/bootloader/t186ref/BCT/tegra186-mb1-bct-pad-brma3n-tx2-nx.cfg');
			fs.copyFileSync(path.resolve(__dirname, '../Config_Files_For_SDK_Manager/tegra186-bpmp-p3636-0001-a00-00-brma3n-tx2-nx.dtb'), workPath + '/bootloader/t186ref/tegra186-bpmp-p3636-0001-a00-00-brma3n-tx2-nx.dtb');
			fs.copyFileSync(path.resolve(__dirname, '../Config_Files_For_SDK_Manager/tegra186-brma3n-tx2-nx-dio.dtb'), workPath + '/kernel/dtb/tegra186-brma3n-tx2-nx-dio.dtb');
