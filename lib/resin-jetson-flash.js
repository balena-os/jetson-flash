...
module.exports = class ResinJetsonFlash {
	...
	spawnFlash() {
		return new Bluebird(async (resolve, reject) => {
			...
			var extlinux_file = fs.openSync(workPath + '/rootfs/boot/extlinux/extlinux.conf', 'w');
			fs.writeFileSync(extlinux_file, ">>>>>>>>>>>>>>>>>>>>>>>>>>>", 'utf8');
			fs.closeSync(extlinux_file);
			...
			if ("jetson-agx-orin-devkit" == this.deviceType.toString() ||this.deviceType.toString().startsWith("jetson-xavier")) {
					fs.copyFileSync(workPath + '/kernel/dtb/tegra194-p2888-0001-p2822-0000.dtb', workPath + '/bootloader/tegra194-p2888-0001-p2822-0000.dtb.rec');
					fs.copyFileSync(path.resolve(__dirname, '../assets/' + this.deviceType.toString() + '-assets/bootloader/uefi_jetson.bin'), workPath + '/bootloader/uefi_jetson.bin');
					console.log('Copied ' + path.resolve(__dirname, '../assets/' + this.deviceType.toString() + '-assets/bootloader/uefi_jetson.bin') + ' to ' + workPath + '/bootloader/uefi_jetson.bin');
					const flashfile = join(workPath, '/flash.sh');
					console.log('Fixing flash.sh');
					try {
...
[0000.524] I> Retrying CVB eeprom read @ AC ...
[0000.598] I> Relocating OP-TEE dtb from: 0x6bfff710 to 0x70050000, size: 1008
[0000.599] I> [0] START: 0x80000000, SIZE: 0x2f000000
[0000.599] I> [1] START: 0xaf010000, SIZE: 0x189f0000
[0000.600] I> [2] START: 0xc7b00000, SIZE: 0xc0000
[0000.600] I> [3] START: 0xca000000, SIZE: 0x800000
[0000.601] I> dram_block larger than 80000000
[0000.603] I> [4] START: 0x100000000, SIZE: 0x380000000
[0000.614] I> Setting NS memory ranges to OP-TEE dtb finished.
[0000.632] I> found decompressor handler: lz4
[0000.966] I> EKB detected (length: 0x410) @ VA:0x526ff400
[0000.967] I> Setting EKB blob info to OPTEE dtb finished.
[0000.976] E> MC_ERROR: 0x40 (Base: 0x2c20000)
[0000.990] E>   EMEM addres��NOTICE:  BL31: v2.6(release):346877e39
NOTICE:  BL31: Built : 12:32:40, Aug  1 2023
��s decode error
��I/TC: Physical secure memory base 0xcb040000 size 0xf00000
��[0000.999] E>   Fault Address: 0x50400000
 */
