...
module.exports = class ResinJetsonFlash {
	...
	spawnFlash() {
		return new Bluebird(async (resolve, reject) => {
			...
			fs.copyFileSync(path.resolve(__dirname, '../Config_Files_For_SDK_Manager/forecr/tegra19x-mb1-pinmux-p3668-a01_forecr_dsb_nx2.cfg'), workPath + '/bootloader/t186ref/BCT/tegra19x-mb1-pinmux-p3668-a01.cfg');
			if ("jetson-agx-orin-devkit" == this.deviceType.toString() || this.deviceType.toString().startsWith("jetson-xavier")) {
					...
					console.log('Fixing flash.sh for L4T 35.1');
					try {
